...
*/
;
define("backbone", ["json","underscore","jquery"], (function (global) {
    return function () {
        var ret, fn;
...
define('Custom',['underscore', 'socketio', 'backbone'], function(_, io, Backbone) {
   var Custom = {
      socket: null
      , origSync: null
      , sharedGame: null
...
define('collections/games',['jquery', 'underscore', 'backbone',
 'models/game'],
...
define("bootbox", ["bootstrap","jquery"], (function (global) {
    return function () {
        var ret, fn;
...
define('text!templates/game-controls.html',[],function () { return '<div class="gameControls row-fluid">\n   <div class="span2">\n      <div class="row-fluid">\n         <div class="span12">\n            <a class="prevPlayerButton btn btn-inverse btn-block btn-large">\n               <i class="icon-arrow-left"></i>\n               <span>\n                  <span class="visible-desktop">Previous</span>\n               </span>\n            </a>\n         </div>\n      </div>\n      <div class="row-fluid">\n         <div class="span12">\n            <a class="addPlayerButton btn btn-danger btn-block btn-large">\n               <i class="icon-plus"></i>\n               <i class="icon-user"></i>\n               <span>\n                  <span class="visible-desktop">Add Player</span>\n               </span>\n            </a>\n         </div>\n      </div>\n   </div>\n   <div class="span2">\n      <div class="row-fluid">\n         <div class="span12">\n            <a class="startClockButton btn btn-block btn-large">\n               <i class="<%= \n                  state == \'paused\' ? \'icon-play\' : state == \'active\' ? \'icon-pause\' : \'icon-refresh\' %>"></i>\n               <span>\n                  <span class="visible-desktop"><%= state == \'paused\' ? \'Start\' : \'Pause\' %></span>\n               </span>\n            </a>\n         </div>\n      </div>\n      <div class="row-fluid">\n         <div class="span12">\n            <a class="gameSettingsButton btn btn-warning btn-block btn-large">\n               <i class="icon-cog"></i>\n               <span>\n                  <span class="visible-desktop">Options</span>\n               </span>\n            </a>\n         </div>\n      </div>\n   </div>\n   <div class="span8">\n      <a class="nextPlayerButton btn btn-primary btn-large btn-block">\n         <i class="icon-arrow-right"></i>\n         <span>\n            <span class="hidden-phone">Next</span>\n         </span>\n      </a>\n   </div>\n</div>\n';});
...
define('text!templates/game-list-item.html',[],function () { return '<strong><%-name%></strong> <%-_.capitalize(state)%> (<%-players.length%> Playing)\n';});

define('views/game-list-item-view',['jquery', 'underscore', 'backbone',
'views/game-view',
...
define('views/game-list-view',['jquery', 'underscore', 'backbone',
...
define('views/new-game-view',['jquery', 'underscore', 'backbone', 'custom',
...
define('client',["jquery", "underscore", "backbone", 'Custom',
'collections/games',
'models/game',
